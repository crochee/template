...
func ExampleCatcher_callers() {
	...
	// Output:
	// woslo/conc/panics.(*Catcher).tryRecover
	// runtime.gopanic
	// woslo/conc/panics.ExampleCatcher_callers.func1
	// woslo/conc/panics.(*Catcher).Try
	// woslo/conc/panics.ExampleCatcher_callers
	// testing.runExample
	// testing.runExamples
	// testing.(*M).Run
	// main.main
