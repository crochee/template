...
func Register(ctx context.Context, connector func(context.Context, ...func(opt *storage.Opt)) *storage.DB) error {
...
func NewDBPolicyGetter(name string, connector func(context.Context, ...func(opt *storage.Opt)) *storage.DB) *dbPolicyGetter {
...
type dbPolicyGetter struct {
	connector func(context.Context, ...func(opt *storage.Opt)) *storage.DB
	name      string
}
